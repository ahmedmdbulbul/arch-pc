...
author: "Ахмед МД Булбул НКАбд-01-23"
...
![Ключ для подписи](image/05.png){ #fig:005 width=70%, height=70% }

И добавляю ключ в профиль на гитхабе

![Добавляю ключ](image/06.png){ #fig:006 width=70%, height=70% }
...
![commit push](image/09.png){ #fig:009 width=70%, height=70% }
